...
abstract class NavigationBus {
  ...
  static get animation => (NavigationBus.tabController == null) ? AlwaysStoppedAnimation(1.0) : NavigationBus.tabController.animation;

  static set(TabController x) {
    _tabController = x;
  }
  ...
  static StreamSubscription registerNavigationListener(Function listener) => _bus.on<AppNavEvent>().listen(listener);

  static StreamSubscription registerControllerAttachedListener(Function listener) => _bus.on<ControllerAttachedEvent>().listen(listener);
